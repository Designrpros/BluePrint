...
// ProjectComponentPage Component for Modal

export default function ModalPage({ params }: { params: { projectName: string } }) {
  ...
  return (
    <>
      <ProjectComponentContainer>
        <Header>
          <HeaderContent>
            <Title>Modal in {selectedProject.name}</Title>
            <Description>
              Below is a preview of the Modal component as used in the {selectedProject.name} project.
            </Description>
          </HeaderContent>
        </Header>
        ...
        <ProjectComponentSection>
          ...
          <ProjectComponentContent>
            <ComponentWrapper>
              <StyledModal>Modal Content</StyledModal>
            </ComponentWrapper>
          </ProjectComponentContent>
        </ProjectComponentSection>
      </ProjectComponentContainer>
