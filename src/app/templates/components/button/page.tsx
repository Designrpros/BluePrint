...
// ProjectComponentPage Component for Button

export default function ButtonPage({ params }: { params: { projectName: string } }) {
  ...
  return (
    <>
      <ProjectComponentContainer>
        <Header>
          <HeaderContent>
            <Title>Button in {selectedProject.name}</Title>
            <Description>
              Below is a preview of the Button component as used in the {selectedProject.name} project.
            </Description>
          </HeaderContent>
        </Header>
